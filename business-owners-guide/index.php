...
<div class="row main" style="padding-left:0; padding-top:10px;">
	...
	<div class="col-9" style="padding-left:3%;">
		<h1 style="color:#0166A3;">Business Owner Guide</h1>
		<div class="proactive col-10">
			<h2 class="green">Small and Medium Business Owners Guide to IT Pricing</h2>
			<p>Get a better understanding of outsourced IT pricing and learn everything you need to know.</p>
		</div>
		<div class="casestudies col-10">
			<div class="col-12"><img class="col-12" src="<?php echo $r; ?>media/r47.svg"/></div>
		</div>
		<div class="otherresources col-10">
			<form action="https://cgnew.wpengine.com/apis/cgcg/form/guide/" method="POST">
